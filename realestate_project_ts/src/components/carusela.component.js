...
const nextCarselaImage = () => {
    let carusela_img_selected = document.getElementById(`carusela_img_${caruselaActivePhoto}`);
    ...
    let carusela_img_selected2 = document.getElementById(`carusela_img_${caruselaActivePhoto}`);
